  ...
  create view "fresh_segments"."analytics"."alerts_dbt_source_freshness__dbt_tmp"
...
with results as (
  select * from "fresh_segments"."analytics"."dbt_source_freshness_results"
),

sources as (
  select * from "fresh_segments"."analytics"."dbt_sources"
)
