  ...
  create view "fresh_segments"."analytics"."snapshot_run_results__dbt_tmp"
...
with dbt_run_results as (
    select * from "fresh_segments"."analytics"."dbt_run_results"
),

dbt_snapshots as (
    select * from "fresh_segments"."analytics"."dbt_snapshots"
)
